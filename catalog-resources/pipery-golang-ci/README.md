# Pipery Go CI Component

Reusable GitLab CI/CD component for complete Go CI pipeline with structured logging.

## Overview

This component provides a complete CI/CD pipeline for Go projects:
- SAST scanning
...
```yaml
include:
  - component: $CI_SERVER_FQDN/pipery-dev/pipery-golang-ci/catalog-resources/pipery-golang-ci@main
...
| GO_VERSION | 1.21 | Go runtime version |
