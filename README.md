# <img src="https://raw.githubusercontent.com/feathericons/feather/master/icons/activity.svg" width="28" align="center" /> Pipery Go CI
...
| `tests_path` | `./...` | Go package path passed to `go test` (e.g. `./pkg/...`). |
